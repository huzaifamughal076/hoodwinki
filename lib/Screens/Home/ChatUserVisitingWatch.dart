...
class ChatUserVisitingWatch extends StatefulWidget {
  final watchId;
  UserModel userModel;

  ChatUserVisitingWatch(this.watchId,this.userModel, {Key? key}) : super(key: key);

  @override
  State<ChatUserVisitingWatch> createState() => _ChatUserVisitingWatchState();
}
class _ChatUserVisitingWatchState extends State<ChatUserVisitingWatch> {
  bool value = false;
      ...
      body: Stack(
        children: [
          ...
          SingleChildScrollView(
            ...
            (location==null)?Center(child: CircularProgressIndicator(color: AppColors.orange,)):Visibility(
              visible: false,
                child: Container()),
        ],
      ),
